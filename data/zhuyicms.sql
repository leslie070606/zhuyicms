...
--
-- Host: localhost
-- Generation Time: 2016-07-07 13:14:33
...
('/zyuser/*', 2, NULL, NULL, NULL, 1467883423, 1467883423),
('/zyuser/index', 2, NULL, NULL, NULL, 1467883577, 1467883577),
('超级管理员', 1, '超级管理员', NULL, NULL, 1466654830, 1467883447);
...
(7, '上传', NULL, '/upload/upload', 3, 0x7b2269636f6e223a202266612066612d75706c6f6164222c202276697369626c65223a20747275657d),
(8, '权限控制', NULL, NULL, 4, 0x7b2269636f6e223a202266612066612d6765617273222c202276697369626c65223a20747275657d),
(9, '路由', 8, '/admin/route/index', NULL, NULL),
(10, '权限', 8, '/admin/permission/index', NULL, NULL),
(11, '角色', 8, '/admin/role/index', NULL, NULL),
(12, '分配', 8, '/admin/assignment/index', NULL, NULL),
(13, '菜单', 8, '/admin/menu/index', NULL, NULL),
(14, '住艺用户管理', NULL, NULL, 1, 0x7b2269636f6e223a202266612066612d75736572222c202276697369626c65223a20747275657d),
(15, '用户列表', 14, '/zyuser/index', NULL, NULL);
...
--
-- 转存表中的数据 `zyj_designer_additional`
--

INSERT INTO `zyj_designer_additional` (`id`, `designer_id`, `ideal_customer`, `ideal_process`, `pain_point`, `source`, `custom_service`, `recommend`, `ideas`, `works`, `share_video`, `shared_video`, `share_text`, `shared_text`, `phone`, `wechat`, `email`, `address`, `card_no`, `bank`) VALUES
(1, 2, 'w', 's', 's', 's', 's', 's', 's', 's', 's', 's', 's', 's', 's', 's', 's', 's', 's', 's');
...
INSERT INTO `zyj_project` (`project_id`, `user_id`, `city`, `house_type`, `completion_time`, `room_area`, `budget_ceiling`, `service_item`, `generic_require`, `description`, `residential_district`, `photo`, `status`, `createtime`, `updatetime`) VALUES
(1, 2, 1, 1, 1, 'ww', 'sdas', 2, 2, 'asdasdasd', 'asd', 'sdas', 1, 123123, 123123);
...
CREATE TABLE `zy_designer` (
  `designer_id` int(10) UNSIGNED NOT NULL COMMENT 'ID主键',
  ...
  `email` varchar(50) NOT NULL COMMENT '设计师邮箱',
  `job_year` varchar(20) NOT NULL COMMENT '从业年限',
  `ever_office` varchar(50) NOT NULL COMMENT '已往服务的事务所/设计公司',
  `company` varchar(50) NOT NULL COMMENT '就职机构及职位头衔 ',
  `alma_mater` varchar(50) NOT NULL COMMENT '毕业院校及专业',
  `address_city` varchar(50) NOT NULL COMMENT '现居住城市 ',
  `service_city` varchar(50) DEFAULT NULL COMMENT '客服务的城市',
  `ideas` varchar(80) NOT NULL COMMENT '设计理念',
  `style` varchar(50) NOT NULL COMMENT '风格偏好（最少选3项）） ',
  `customer` varchar(50) NOT NULL COMMENT '客户对象 ',
  `service_type` varchar(50) NOT NULL COMMENT '设计服务类型',
  `cost_home` varchar(50) NOT NULL COMMENT '家装设计费报价（元/平米）',
  `cost_work` varchar(50) NOT NULL COMMENT '工装设计费报价（元/平米）',
  `ying_include_project` varchar(50) NOT NULL COMMENT '硬装设计费包含项目（家装/工装）',
  `cost_ruan` varchar(50) NOT NULL COMMENT '硬装设计费包含项目（家装/工装）',
  `ruan_include_project` varchar(50) NOT NULL COMMENT '软装设计费包含项目',
  `build_include_project` varchar(50) NOT NULL COMMENT '建筑设计费包含项目',
  `cost_build` varchar(50) NOT NULL COMMENT '建筑设计费报价（元/平米）',
  `cost_scenery` varchar(50) NOT NULL COMMENT '景观设计费报价（元/平米）',
  `scenery_include_project` varchar(50) NOT NULL COMMENT '景观设计费包含项目',
  `cost_consult` varchar(50) NOT NULL COMMENT '顾问咨询费报价（元/2小时）',
  `cost_include_project` varchar(50) NOT NULL COMMENT '顾问咨询费包含项目'
...
CREATE TABLE `zy_project` (
  `project_id` int(10) UNSIGNED NOT NULL COMMENT 'ID主键',
  `user_id` int(10) UNSIGNED NOT NULL COMMENT '用户ID',
  `city` varchar(50) NOT NULL COMMENT '城市',
  `address` varchar(100) NOT NULL COMMENT '地址',
  `village` varchar(50) DEFAULT NULL COMMENT '小区',
  `decoration_type` varchar(50) DEFAULT NULL COMMENT '工装/家装',
  `covered_area` varchar(50) DEFAULT NULL COMMENT '建筑面积',
  `use_area` varchar(50) DEFAULT NULL COMMENT '使用面积',
  `budget_sum` varchar(50) DEFAULT NULL COMMENT '预算总额',
  `budget_ruan` varchar(50) DEFAULT NULL COMMENT '软装预算',
  `budget_ying` varchar(50) DEFAULT NULL COMMENT '硬装预算',
  `budget_yuanlin` varchar(50) DEFAULT NULL COMMENT '园林预算',
  `work_time` varchar(100) DEFAULT NULL COMMENT '开工时间',
  `home_type` varchar(100) DEFAULT NULL COMMENT '房型',
  `project_status` varchar(100) DEFAULT NULL COMMENT '状态',
  `service_type` varchar(100) DEFAULT NULL COMMENT '服务类型',
  `home_img` varchar(50) DEFAULT NULL COMMENT '家的照片',
  `favorite_img` varchar(50) DEFAULT NULL COMMENT '喜欢的照片',
  `designer_level` varchar(50) DEFAULT NULL COMMENT '设计师档次',
  `match_json` varchar(200) DEFAULT NULL COMMENT '匹配内容字符串JSON'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目需求表';
...
INSERT INTO `zy_user` (`user_id`, `project_id`, `style_id`, `favored_designer_ids`, `name`, `openid`, `nickname`, `phone`, `email`, `status`, `profession`, `sex`, `city`, `language`, `country`, `headimgurl`, `unionid`, `privilege`, `address`, `create_time`, `update_time`) VALUES
(1, 1, 1, '啊实打实的', '啊23', 'd打发打发', '水电费水电费', '水电费水电费', '526080515', 1, '水电费', 2, '胜多负少', '水电费', '水电费', '水电费', '水电费', '水电费', '胜多负少', 12312, 123123);
...
--
-- Indexes for table `zy_designer`
--
ALTER TABLE `zy_designer`
...
--
-- Indexes for table `zy_project`
--
ALTER TABLE `zy_project`
  ADD PRIMARY KEY (`project_id`);
...
--
ALTER TABLE `zyj_designer_additional`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID主键', AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `zyj_project`
  MODIFY `project_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=2;
--
...
--
-- 使用表AUTO_INCREMENT `zy_designer`
--
ALTER TABLE `zy_designer`
  MODIFY `designer_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID主键';
--
...
--
-- 使用表AUTO_INCREMENT `zy_project`
--
ALTER TABLE `zy_project`
  MODIFY `project_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID主键';
--
