...
/**
 * 网关地址
 http://hprpt2.eucp.b2m.cn:8080/sdk/SDKService?wsdl

 http://sdkhttp.eucp.b2m.cn/sdk/SDKService
 */
 ...
 * 序列号,请通过亿美销售人员获取
 0SDK-EBB-6699-RHSLS
 */
$serialNumber = '8SDK-EMY-6699-RIUSM';
 ...
 * 短信发送 用例
 */
function sendSMS($arr=array(18801039883),$content='欢迎使用易配件！')
{
	 ...
	 */
	$statusCode = $client->sendSMS($arr,$content);
	echo "处理状态码:".$statusCode;
}
