       ...
       <div id="desib" class="desib_box">
        ...
        <?php } ?>
         <div class="gloab_bottm">
             <img id="erweima" class="erweima" src="img/ewm/6.png"  />
...
<script type="text/javascript">
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareAppMessage({
            title: '<?php echo $userInfo['nickname'] ?>说自己很「<?= $mystyle['style'] ?>」并向你扔了一块榻榻米', // 分享标题
        ...
        wx.onMenuShareTimeline({
            title: '<?php echo $userInfo['nickname'] ?>说自己很「<?= $mystyle['style'] ?>」并向你扔了一席榻榻米,还想看看你的家居风格是什么', // 分享标题
            link: "<?php echo Yii::$app->params['frontDomain']; ?>" + '/index.php?r=style/report&link_id=' + "<?= $link_id ?>", // 分享链接
