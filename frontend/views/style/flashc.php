     ...
     <div id="desib" class="desib_box">
            <div class="miaoshu">
                ...
                <div class="miaodian_text">
                    ...
                    你了解哥特的摩尔式线形，通晓巴洛克的多边曲面、复杂形象和精细雕花，也熟知洛可可自然、纤细与轻快。从中世纪和文艺复兴流传至今的美学里，你看到了欧洲复古混搭世纪的精致生活。那些丰盈而饱满似雕塑的曲线以及色彩斑斓的形式令人迷恋，让平淡如水的生活生出了更多浪漫与热情。而繁复交织的色彩，微微闪光的金箔、流苏璀璨的水晶灯还有重重叠叠的天鹅绒也为日常的空间制造出精巧的梦幻感。在这个弥散着古典情怀的家中，所有装饰并非为了炫耀奢华，而是为了提醒你日常的精巧。
                </div>
            </div>
                </span>
            </div>
            ...
            <div class="share_box share_box_active">
               <div class="miaodian_mesng meng_top btn_miaodian">
                    ...
                    <div class="miaodian_text">
                        ...
                        点击分享出去的链接，即可查看和好友的心有灵犀度。如果你与好友测试结果相同，你们两人都将有机会得到HAY的礼品套装。 关注「住艺」微信订阅号，10月27日将公布获奖名单。
                        <div class="text_img">
...
<script type="text/javascript">
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareAppMessage({
            title: '<?php echo $userInfo['nickname'] ?>说自己很「<?= $mystyle['style'] ?>」并向你扔了一枚水晶吊灯', // 分享标题
