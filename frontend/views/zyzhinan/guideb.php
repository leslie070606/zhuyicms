	...
	<div class="guide_box">
		...
		<div class="guide_box_here">
			...
			<div class="here_b_box">
				...
				<span class="box_spb">硬装设计指的是对于空间利用，结构改造，主材使用等需要施工环节的设计。软装通俗的说，就是你把房子倒过来，掉下来的都属于软装，如窗帘、沙发、靠垫、壁挂、地毯、床上用品、灯具等以及装饰工艺品、植物等。简单地说，如果你需要任何施工，那么你就需要一名硬装设计师；如果只是家具或陈列品的更换，则需要一名软装设计师。有一些造诣高的硬装设计师也可以在完成硬装设计的同时完成软装设计，但普遍来说两者都是分开的。</span>
			</div>
			<div class="here_b_box">
				<span class="box_spa"><i></i>了解这几点再找设计师，更高效</span>
				<span class="box_spb">好的设计不可能一天完成，要给设计师预留充分的设计时间（一般在30-45天左右），这样才能确保设计以及施工质量。</span>
			...
			<div class="here_b_box">
				...
				<span class="box_spb">如何找到合适自己的设计师？</span>
